...
function initAdmin(socket) {
  ...
  var onDelete = document.querySelectorAll('.delete');
  onDelete.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      var pizzaId = btn.dataset.pizza;
      console.log(pizzaId);
  ...
  socket.on('orderPlaced', function (order) {
    ...
    orders.unshift(order); // for pushhing an element top in array
...
onDelete.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var pizzaId = btn.dataset.pizza;
    // console.log(pizzaId);
    axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"]('/api/menu/' + pizzaId).then(function (res) {
      console.log(res);
      location.reload();
      notie__WEBPACK_IMPORTED_MODULE_2___default().alert({
        type: 'success',
...
var adminAreaPath = window.location.pathname; //for receiving the path name
...
/******/ 		var installedChunks = {
/******/ 			"/public/javascripts/app": 0,
/******/ 			"public/stylesheets/app": 0
/******/ 		};
/******/ 		
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkonline_food_delivery"] = self["webpackChunkonline_food_delivery"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["public/stylesheets/app"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["public/stylesheets/app"], () => (__webpack_require__("./resources/scss/app.scss")))
